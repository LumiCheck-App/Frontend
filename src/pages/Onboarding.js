...
import { updateOnboardingStatus } from '../redux/onBoardingSlice';
...
export default function Onboarding({ navigation }) {
  ...
  const steps = [
    {
      ...
      description:
        'Agora um pequeno tutorial, para entenderes a app que pode mudar os teus hábitos de vida',
    },
    {
      id: 1,
      image: step2,
    ...
    },
    {
      ...
      description:
        'Existem diversas pessoas que te querem ajudar, encontra-as no nosso mapa!',
    },
    {
      id: 4,
      image: step5,
  ...
  useEffect(() => {
    ...
    if (currentStep === steps.length - 1 && swipeDistance > 30) {
      handleFinishOnboarding();
    }
  }, [touchEndX]); // roda sempre que um toque termina
