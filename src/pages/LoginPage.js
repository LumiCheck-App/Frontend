      ...
      <View className="px-4">
        <View className="w-11/12 mx-auto flex-col gap-4">
          ...
          <TouchableOpacity
            ...
            className="flex-row w-full items-center justify-end"
          >
            <Text className="text-black font-quickregular underline pt-4">
              Esqueceste-te da password?
            </Text>
          </TouchableOpacity>

          {hasError && (
            <Text className="text-red font-quickbold text-center w-full">
              {error}
            </Text>
          )}
